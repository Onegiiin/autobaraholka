...
import by.autobaraholka.userMicroservice.model.Role;
...
public class UserService {
    ...
    public User getCurrentUser() {
        // Получение email из контекста Spring Security
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String email = (authentication != null) ? authentication.getPrincipal().toString() : null;
